...
> Операционный how-to: создать PostHog-проект и события для трекинга GitHub profile README.
> Реализует **REQ-027** в [`docs/prd-v2.md`](prd-v2.md) — требование **deferred**;
> гайд держим готовым, чтобы разблокировать дешево. UTM-схема — в
> [`docs/development.md`](development.md#utm-scheme).
...
### 3.1 Ручной учёт контактов (North Star)
